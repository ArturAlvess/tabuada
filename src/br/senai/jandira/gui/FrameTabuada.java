...
public class FrameTabuada {
	...
	public void criarTela() {
		...
		textFieldMult.setHorizontalAlignment(JTextField.RIGHT);
		...
		textFieldMin.setHorizontalAlignment(JTextField.RIGHT);
			...
			public void actionPerformed(ActionEvent e) {
				try {
					if (textFieldMult.getText().isEmpty()) {
						JOptionPane.showMessageDialog(null, "O multiplicando é obrigatório", "Erro!",
								JOptionPane.OK_OPTION);
						textFieldMult.requestFocus();

					} else if (textFieldMin.getText().isEmpty()) {
						JOptionPane.showMessageDialog(null, "O mínimo multiplicador é obrigatório.", "Erro!",
								JOptionPane.OK_OPTION);
						textFieldMin.requestFocus();
					} else if (textFieldMax.getText().isEmpty()) {
						JOptionPane.showMessageDialog(null, "O máximo multiplicador é obrigatório.", "Erro!",
								JOptionPane.OK_OPTION);
						...
						if (tabuada.maximoMultiplicador >= tabuada.minimoMultiplicador) {
							...
							JOptionPane.showMessageDialog(null, "O mínimo multiplicador deve ser menor que o máximo.",
					...
					JOptionPane.showMessageDialog(null, "Erro - Caractere inválido!", "Erro",
